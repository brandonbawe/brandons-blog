...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Brandon\'s Blog') }}
                </a>
        ...
        <footer>
            <div class="footer-inner d-sm-flex flex-md-column flex-sm-column">
                <h2><a href="">Brandon's Blog</a></h2>
                <ul>
                    <h3>Resources</h3>
                    <li><a href="">Our Blog</a></li>
                    <li><a href="">Career Orientation</a></li>
                ...
                <ul>
                    <h3>Our Partners</h3>
                    <li><a href="">Google LLC</a></li>
                    <li><a href="">Forbes Magazine</a></li>
